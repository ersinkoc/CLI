...
- **Dependencies**: 13.1
- **Complexity**: High
- **Files**: tests/integration/\*_/_.test.ts
...
- **Dependencies**: 13.1
- **Complexity**: Medium
- **Files**: examples/01-basic/\*_/_.ts
...
- **Dependencies**: 13.1
- **Complexity**: Medium
- **Files**: examples/02-api-styles/\*_/_.ts
...
- **Dependencies**: 9.12
- **Complexity**: Medium
- **Files**: examples/03-prompts/\*_/_.ts
...
- **Complexity**: Medium
- **Files**: examples/04-output/\*_/_.ts
...
- **Dependencies**: 8.3
- **Complexity**: Medium
- **Files**: examples/05-validation/\*_/_.ts
...
- **Complexity**: High
- **Files**: examples/06-real-world/\*_/_.ts
...
- **Dependencies**: 18.4
- **Complexity**: High
- **Files**: website/src/pages/\*_/_.tsx
